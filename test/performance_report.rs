...
fn generate_performance_report() {
    ...
    println!(
        "  获取延迟 - P50: {:.2}μs, P95: {:.2}μs, P99: {:.2}μs",
    ...
    println!(
        "  归还延迟 - P50: {:.2}μs, P95: {:.2}μs, P99: {:.2}μs",
    ...
    println!(
        "  单线程平均吞吐量: {:.2} ops/sec",
        concurrent_throughput / num_threads as f64
    );
    println!();
    ...
    println!(
        "  平均创建时间: {:.2} ms",
        avg_create_time as f64 / 1_000_000.0
    );
    println!(
        "  P95创建时间: {:.2} ms",
        p95_create_time as f64 / 1_000_000.0
    );
    println!(
        "  创建速率: {:.2} conn/sec",
        create_count as f64 / create_duration.as_secs_f64()
    );
    println!();
    ...
    println!(
        "  吞吐量: {:.2} stats/sec",
        stats_iterations as f64 / stats_duration.as_secs_f64()
    );
    println!(
        "  平均延迟: {:.2} ns ({:.2} μs)",
        avg_stats_latency,
        avg_stats_latency as f64 / 1000.0
    );
    println!(
        "  P99延迟: {:.2} ns ({:.2} μs)",
        p99_stats_latency,
        p99_stats_latency as f64 / 1000.0
    );
    println!();
