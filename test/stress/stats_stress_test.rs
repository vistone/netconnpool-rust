...
fn test_stats_record_get_time_consistency() {
    ...
    assert_eq!(
        ...
        (num_threads * operations_per_thread) as i64
    );
}
...
fn test_stats_long_running() {
    ...
    while start.elapsed() < test_duration {
        ...
        if iteration % 1000 == 0 {
            ...
            println!(
                "迭代 {}: 创建数={}, 获取数={}",
                iteration, stats.total_connections_created, stats.successful_gets
            );
        }
    }
