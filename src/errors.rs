...
impl PartialEq for NetConnPoolError {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Self::ConnectionClosed { connection_id: id1 }, Self::ConnectionClosed { connection_id: id2 }) => id1 == id2,
            (Self::GetConnectionTimeout { .. }, Self::GetConnectionTimeout { .. }) => true,
            (Self::MaxConnectionsReached { current: c1, max: m1 }, Self::MaxConnectionsReached { current: c2, max: m2 }) => c1 == c2 && m1 == m2,
            (Self::InvalidConnection { connection_id: id1, .. }, Self::InvalidConnection { connection_id: id2, .. }) => id1 == id2,
            (Self::ConnectionUnhealthy { connection_id: id1 }, Self::ConnectionUnhealthy { connection_id: id2 }) => id1 == id2,
            (Self::InvalidConfig { reason: r1 }, Self::InvalidConfig { reason: r2 }) => r1 == r2,
            (Self::ConnectionLeaked { connection_id: id1, .. }, Self::ConnectionLeaked { connection_id: id2, .. }) => id1 == id2,
            (Self::PoolExhausted { current: c1, max: m1 }, Self::PoolExhausted { current: c2, max: m2 }) => c1 == c2 && m1 == m2,
            (Self::UnsupportedIPVersion { version: v1 }, Self::UnsupportedIPVersion { version: v2 }) => v1 == v2,
            (Self::NoConnectionForIPVersion { required: r1 }, Self::NoConnectionForIPVersion { required: r2 }) => r1 == r2,
            (Self::UnsupportedProtocol { protocol: p1 }, Self::UnsupportedProtocol { protocol: p2 }) => p1 == p2,
            (Self::NoConnectionForProtocol { required: r1 }, Self::NoConnectionForProtocol { required: r2 }) => r1 == r2,
